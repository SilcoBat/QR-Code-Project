...
class RaspberryApp(tk.Tk):
    ...
    def __init__(self):
        ...
        # WiFi interfÃƒÆ’Ã‚Â©sz (wlan0) IP cÃƒÆ’Ã‚Â­mÃƒÆ’Ã‚Â©nek lekÃƒÆ’Ã‚Â©rdezÃƒÆ’Ã‚Â©se
        ...
        try:
            ...
            ip_address = 'Nincs WiFi kapcsolat vagy az interfÃƒÆ’Ã‚Â©sz nem elÃƒÆ’Ã‚Â©rhetÃƒâ€¦Ã¢â‚¬Ëœ'
...
class LoginPage(ttk.Frame):
    ...
    def __init__(self, master):
        ...
        self.label = ttk.Label(self, text="Prihlasovacia strÃ¡nka", font=("Helvetica", 50))

        self.label.pack(padx=10, pady=20)

        

        self.label2 = ttk.Label(self, text="ProsÃ­m, naskenujte svoju kartu", font=("Helvetica", 25))
...
class MainPage(ttk.Frame):
    ...
    def __init__(self, master):
        ...
        self.label = ttk.Label(self, text="StrÃ¡nka na skenovanie WO", font=("Helvetica", 50))

        self.label.pack(padx=10, pady=10)



        self.username_label = ttk.Label(self, text="PouÅ¾Ã­vateÄ¾ prihlÃ¡senÃ½ ako: ", font=("Helvetica", 20))
        ...
        self.text_box.insert(tk.END, f"ProsÃ­m, najprv naskenujte TOP LEVEL QR kÃ³d.\nAk je TOP LEVEL QR kÃ³d naskenovanÃ½,\nnaskenujte inÃ½ QR kÃ³d.")
                    ...
                    if pn_result:
                        ...
                        if self.is_work_order_active(pn_id):
                            ...
                            if result and result[0] > 1:
                                ...
                                self.text_box.insert(tk.END, f"TOP LEVEL QR kÃ³d bol uÅ¾ naskenovanÃ½.\nProsÃ­m, naskenujte inÃ½ SUB QR kÃ³d.\nDetaily: \nWO: {wo_value}\nPN: {pn_value}")
    ...
    def complete_work_order(self, work_order_id, hierarchy):
        ...
        confirm_window.title("DokonÄenie pracovnÃ©ho procesu")



        # Ãœzenet a felugrÃ³ ablakban

        message_label = ttk.Label(confirm_window, text="Si si istÃ½, Å¾e chceÅ¡ dokonÄiÅ¥ tento pracovnÃ½ proces?")
        ...
        def confirm():
            ...
            qty_window.title("Zadajte mnoÅ¾stvo")



            qty_message_label = ttk.Label(qty_window, text="KoÄ¾ko kusov posielate?")
            ...
            def submit_qty(event=None):
                ...
                if not qty_value.isdigit() or int(qty_value) <= 0:
                    ...
                    messagebox.showerror("NeplatnÃ½ Ãºdaj", "ProsÃ­m, zadajte platnÃ© mnoÅ¾stvo!")
                ...
                confirm_qty_window.title("Potvrdenie mnoÅ¾stva")
                ...
                qty_confirm_message_label = ttk.Label(
                    ...
                    text=f"Si si istÃ½, Å¾e si dokonÄil {self.qty_value} kusov?"
                ...
                def confirm_qty():
                    ...
                    if result:
                        ...
                        self.text_box.insert(tk.END, f"WO {wo_value} dokonÄenÃ©.\nÃšdaje o WO: \n{hierarchy}\nECN: {ecn_value}\nQTY: {qty_value}\nREV: {rev_value}\nNaskenujte novÃ½ QR kÃ³d alebo naskenujte \nPROCESS-QR kÃ³d, ak ste zabudli.")
                ...
                yes_button_qty = ttk.Button(confirm_qty_window, text="Ãno (1)", command=confirm_qty)
        ...
        yes_button = ttk.Button(confirm_window, text="Ãno (1)", command=confirm)
    ...
    def handle_process_qr(self, qr_code_text):
        ...
        if "PROCESS" in process_data and self.master.current_work_order_id:
            ...
            if process_check[0] == '' or process_check[0] == 'N/A':
                ...
                self.text_box.insert(tk.END, "Najprv musÃƒÂ­Ã…Â¡ skenovaÃ…Â¥ STATION-QR.")
    ...
    def update_username(self):
        ...
        if worker:
            ...
            self.username_label.config(text=f"PouÅ¾Ã­vateÄ¾ prihlÃ¡senÃ½ ako: {worker[0]}")
