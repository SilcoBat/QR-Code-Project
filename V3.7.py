        ...
        if hierarchy:
            ...
            if sub1_start != -1:
                if sub1_end != -1:
                    ...
                    sub1_value = hierarchy[sub1_start + 6:].strip()  # Ha nincs "SUB2: ", akkor a string végét használjuk

            # FIND SUB2
            sub2_start = hierarchy.find("SUB2: ")
            if sub2_start != -1:
                sub2_value = hierarchy[sub2_start + 6:].strip()  # A "SUB2: " utáni érték
        ...
        if master_pn_value == pn_value:
            ...
            if hierarchy == "":
                ...
                for i in first_level_sub:
                    hierarchy_value = i[0]  # A második elem a HIERARCHY érték
